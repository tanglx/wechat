...
public class OkHttpUtils {
    ...
    public OkHttpUtils addParam(Map<String, String> params) {
        ...
        params.forEach((k, v) -> paramMap.put(k, v));
        return this;
    }
    ...
    //        params.put("appid", "wxe323a3ff8027d3db");
    //        params.put("secret", "85deb25a1ee5b6ed0081b1bfb9c1bb55");
    //        String aaa = OkHttpUtils.builder().url("https://api.weixin.qq.com/cgi-bin/token")
    //                // 有参数的话添加参数，可多个
    //                .addParam(params)
    //                // 也可以添加多个
